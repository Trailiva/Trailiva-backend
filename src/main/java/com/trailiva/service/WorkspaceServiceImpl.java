...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    @Override
    public void assignContributorToTaskOnOfficialWorkspace(AssignTaskRequest request) throws WorkspaceException, TaskException, UserException {
        OfficialWorkspace workspace = getOfficialWorkspace(request.getWorkspaceId());
        boolean isValidModerator = isValidMember(workspace.getModerators(), request.getModeratorId());
        ...
        if (isValidContributor && isValidModerator) {
            assignTask(request.getModeratorId(), request.getContributorId(), request.getTaskId());
